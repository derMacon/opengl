...
const int levelTimes[3] = {5, 50000, 30000};

const int startPosLevels[3][2] = {{1, 1},
                                  {4, 6},
                                  {3, 3}};
const pushyLevel level1 = {{P_WALL, P_WALL, P_WALL, P_WALL,            P_WALL,        P_WALL,   P_WALL, P_WALL,            P_WALL},
...
const pushyLevel level2 = {{P_OUTER, P_WALL,  P_WALL,  P_WALL,  P_OUTER, P_WALL,  P_WALL,   P_WALL,  P_OUTER},
                           {P_WALL,  P_WALL,  P_WALL,  P_WALL,  P_WALL,  P_WALL,  P_TARGET, P_WALL,  P_WALL},
...
const pushyLevel level3 = {{P_WALL, P_WALL,  P_WALL, P_WALL, P_WALL, P_WALL, P_WALL,   P_WALL,   P_WALL},
